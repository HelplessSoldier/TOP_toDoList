...
function openNewItemDialogue(todoParent, parent, array, newItemButton) {
  const newItemDialogueContainer = createElement(
    "div",
    { id: "newItemDialogueContainer" },
    ""
  );

  // title input field
  const titleInputContainer = createElement(
    "div",
    { id: "titleInputContainer" },
    ""
  );
  ...
  const titleInput = createElement(
    "input",
    { id: "titleInput", type: "text" },
    "Title"
  );
  titleInputContainer.append(titleInputLabel, titleInput);

  // description input field
  const descriptionInputContainer = createElement(
    "div",
  ...
  const priorityInputContainer = createElement(
    "div",
    { id: "priorityInputContainer" },
    ""
  );
  const priorityInputLabel = createElement(
    "label",
    { for: "priorityInput" },
    "Priority: "
  );
  const priHighLabel = createElement(
    "label",
    { for: "priorityInputHigh" },
    "High:"
  );
  const priorityInputHigh = createElement("input", {
    id: "priorityInputHigh",
    type: "radio",
    name: "priority",
  });
  const priMidLabel = createElement(
    "label",
    { for: "priorityInputMid" },
    "Medium:"
  );
  const priorityInputMed = createElement("input", {
    id: "priorityInputMed",
    type: "radio",
    name: "priority",
  });
  const priLowLabel = createElement(
    "label",
    { for: "priorityInputLow" },
    "Low:"
  );
  const priorityInputLow = createElement("input", {
    id: "priorityInputLow",
    type: "radio",
    name: "priority",
  });
